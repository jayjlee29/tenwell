...
public class SSOAgentRequestResolver {
    ...
    public boolean isPassiveAuthnRequest() {
        return (ssoAgentConfig.isSAML2SSOLoginEnabled() || ssoAgentConfig.isOpenIdLoginEnabled()) &&
                (request.getSession(false) == null || request.getSession(false).getAttribute(SSOAgentConstants.SESSION_BEAN_NAME) == null);
    ...
    public boolean isSAML2OAuth2GrantRequest() {
        return ssoAgentConfig.isSAML2SSOLoginEnabled() &&
                ...
                ((AgentSessionBean) request.getSession(false).getAttribute(
