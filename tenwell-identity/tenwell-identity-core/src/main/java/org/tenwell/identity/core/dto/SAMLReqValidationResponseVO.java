...
public class SAMLReqValidationResponseVO implements Serializable {

	private static final long serialVersionUID = -1851014819062590391L;
    ...
    private SAMLSingleLogoutRequestVO[] logoutRespDTO;
    ...
    public SAMLSingleLogoutRequestVO[] getLogoutRespDTO() {
        if (logoutRespDTO == null) {
            return new SAMLSingleLogoutRequestVO[0];
        }
        return logoutRespDTO.clone();
    }

    public void setLogoutRespDTO(SAMLSingleLogoutRequestVO[] logoutRespDTO) {
        if (logoutRespDTO == null) {
            this.logoutRespDTO = new SAMLSingleLogoutRequestVO[0];
        } else {
